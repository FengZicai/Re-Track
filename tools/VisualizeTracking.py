...
from tools.NNmodel import Model
from Dataset import SiameseTest
from tools.utils import generate_boxes, getModel
from tools.utils import cropAndCenterPC, regularizePC
from tools/data_classes import Box, PointCloud
...
def main(args):
    ...
    AE_chkpt_file = os.path.join("..", "models", "Pretrain_ShapeNet",
                                 "model.pth.tar")
    chkpt_file = os.path.join("..", "models", args.model_name, "model.pth.tar")
